package cn.iocoder.yudao.module.data.dal.dataobject.sspslotday;
 ...
 * @author 芋道源码
 */
@TableName("data_ssp_slot_day")
@KeySequence("data_ssp_slot_day_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class SspSlotDayDO extends BaseDO {
