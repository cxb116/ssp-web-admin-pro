 ...
 * 日报表折线图 Response VO
 *
 * 用于返回某一天（日期维度）所有符合条件的广告位记录聚合后的各指标数据，
 * 供前端折线图每天一个数据点使用。填充率 / 展现率 / 点击率 / ecpm 等为派生指标，
 * 在 Service 层实时计算返回。
 *
 * @author 芋道源码
 */
@Schema(description = "管理后台 - DSP预算广告位日报表折线图 Response VO")
@Data
@EqualsAndHashCode
@ToString
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DspSlotDayTrendRespVO {
